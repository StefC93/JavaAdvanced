...
public class CallLog implements Comparable<CallLog> {
	...
	public CallLog(Integer id, String naam, Date datum, String bedrijf, String omschrijving, int prio,
	...
	public String toString() {
		return "CallLog [id=" + id + ", naam=" + naam + ", datum=" + getDatumFormatted() + ", bedrijf=" + bedrijf
				+ ", omschrijving=" + omschrijving + ", prio=" + prio + ", status=" + status + "]";
	}

	/**
	 * Compare op bedrijf Let op compares die gelijk uitkomen en het gebruik van
	 * Sets
	 */
	@Override
