...
public class CallLogUtil {
	...
	/**
	 * een manier om een collection op te splitsen in 2 collections op basis van
	 * een voorwaarde via streams
	 * 
	 * @param callLogList
	 */
